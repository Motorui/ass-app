...
use app\views\estatisticas\atrasos\atrasosHelper;
...
/* @var $searchModel app\models\searches\AtrasosSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$gridColumns = atrasosHelper::gridColumns();
$content = atrasosHelper::content();

$this->title = Yii::t('app', 'Atrasos');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="atrasos-index">
    ...
    'columns'=>$gridColumns,
      ...
      'exportConfig' => [
        GridView::EXCEL => [
            ...
            'showFooter' => true,
            'showCaption' => true,
            'filename' => Yii::t('kvgrid', 'Atrasos'),
            'alertMsg' => Yii::t('kvgrid', 'The EXCEL export file will be generated for download.'),
            'options' => ['title' => Yii::t('kvgrid', 'Atrasos - ' .date("r"))],
            'mime' => 'application/vnd.ms-excel',
            'config' => [
                'worksheet' => Yii::t('kvgrid', 'Atrasos'),
                'cssFile' => '',
            ]
        ],
        GridView::PDF => [
            ...
            'config' => [
                ...
                'options' => [
                    'title' =>  Yii::t('kvgrid', 'Atrasos' .date("r")),
      ...
      'panel' => [
          'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-list-alt"></i> Atrasos'
          .'</h3>',
          'type'=>'success',
          'footer'=>true
      ],
